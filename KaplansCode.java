...
class KaplansCode extends DataLinkLayer {
// ===================================================================
    ...
    // ===============================================================
    // The constructor.
    public KaplansCode (PhysicalLayer physicalLayer) {
    ...
    public String format(byte[] arr){
		String output="[";
		for (int dataIndex = 0; dataIndex < arr.length; dataIndex++) {
			output+=arr[dataIndex];
			if (dataIndex!= arr.length-1) {output+="|";}
		}
		output+="]";
		return output;
	}
